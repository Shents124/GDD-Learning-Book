...
public class IAPConfirmService
{
    ...
    {
        //if (PlayerService.ShopService.IsFirstPurchase() == false)
        //{
        //    PlayerService.ShopService.SetFirstPurchase();
        //}
        IAPCount++;
        switch (productData.gameProductType)
        {
            case IAPProductType.undefined:
                break;
            case IAPProductType.Store:
                break;
        }
    }
}
