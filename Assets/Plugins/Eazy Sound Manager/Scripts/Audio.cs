    ...
    public class Audio
    {
        ...
        public Transform SourceTransform
        {
            ...
            set
            {
                if(value == null)
                {
                    sourceTransform = EazySoundManager.Instance.transform;
                }
                else
                {
        ...
        public Audio(AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue, float fadeOutValue, Transform sourceTransform)
        {
            ...
            Pitch = 1;
            StereoPan = 0;
            if (sourceTransform != null && sourceTransform != EazySoundManager.Instance.transform)
            {
                SpatialBlend = 1;
            }
            ReverbZoneMix = 1;
        ...
        public void Play(float volume)
        {
            ...
            if (Pooled)
            {
                ...
                bool restoredFromPool = EazySoundManager.Instance.RestoreAudioFromPool(Type, AudioID);
                if (!restoredFromPool)
                {
                    return;
                }
        ...
        public void Update()
        {
            ...
            var soundManager = EazySoundManager.Instance;
