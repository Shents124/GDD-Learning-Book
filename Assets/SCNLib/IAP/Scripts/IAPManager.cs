...
namespace SCN.IAP
{
    public class IAPManager : MonoBehaviour, IStoreListener, IDetailedStoreListener
    {
        ...
        [SerializeField] private GameObject _subscriptionPopup;
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            IapTracker.LogIapConfirmSuccess(args.purchasedProduct);

            foreach (var product in catalog.allValidProducts)
            {
                if (String.Equals(args.purchasedProduct.definition.id, product.id, StringComparison.Ordinal))
                {
                    IapTracker.LogIapSuccess(args.purchasedProduct);
        ...
        public void OnPurchaseFailed(Product product, PurchaseFailureReason failureReason)
        {
            ...
            IapTracker.LogIapFailed(product, failureReason.ToString());
        ...
        public void OnPurchaseFailed(Product product, PurchaseFailureDescription failureDescription)
        {
            ...
            IapTracker.LogIapFailed(product, failureDescription.ToString());
