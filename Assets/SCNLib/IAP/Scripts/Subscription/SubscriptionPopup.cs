    ...
    public class SubscriptionPopup : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (_buyButtonMonthly != null && _idSubscriptionMonthly != "")
            {
                ...
                {
                    IapTracker.LogIapClick(IAPManager.Instance.GetProduct(_idSubscriptionMonthly));
            ...
            if (_buyButtonAnnual != null && _idSubscriptionAnnual != "")
            {
                ...
                {
                    IapTracker.LogIapClick(IAPManager.Instance.GetProduct(_idSubscriptionAnnual));
            ...
            if (_buyButtonUnlockAll != null && _idUnlockAll != "")
            {
                ...
                {
                    IapTracker.LogIapClick(IAPManager.Instance.GetProduct(_idUnlockAll));
